...
- **v3.0 instructions refresh** — schema 4 → **7**; "read changelog first" → "read CURRENT_STATE.md first"; "governance precedes features" → "governance serves shipping"; retire the weekly-reupload mandate as load-bearing; note the **ADR-014 Claude Code Manual-mode exception**; note the **dual-clone gotcha**.
